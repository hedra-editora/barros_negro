...
\addcontentsline{toc}{chapter}{Apresentação, \scriptsize{por \emph{Tales Ab'Sáber}}}
...
O negro é o símbolo do espírito do mal e do \qb{}demônio.\\
O branco é o símbolo da luz\ldots{}\\
O negro é o símbolo das trevas, e as trevas \qb{}exprimem simbolicamente o mal.\\
...
Voltamos então a assumir uma posição de denunciar as 
raízes \mbox{ }da \mbox{ }dita \mbox{ }``inferioridade'', a criação da racialidade, sua

\noindent{}verdade no racismo e outras verdades da ``velha
...
Assim, ao demonstrar a situação de assimilado do martinicano, \index{Fanon, Frantz}Fanon \mbox{ }deixa claro que o que regula seu \mbox{ }processo psíquico é um desavim consigo mesmo, uma negação de sua

\noindent{}humanidade, por ver no \emph{Outro}
...
Isso elucida dois acontecimentos que são inter"-relaciona-
dos no pensamento de \index{Fanon, Frantz}Frantz Fanon: por um lado, toda identificação hegemônica
