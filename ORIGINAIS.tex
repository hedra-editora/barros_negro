...
"Nós desconfiamos do entusiasmo"\footnote{FANON, F. \emph{Pele negra,
  máscaras brancas}. Tradução de Renato da Silveira. Salvador: EDUFBA,
...
Tornar-se \emph{colaborador}\footnote{Colaborador como colaboracionista
  ...
  aqui exposto, Cf. ARANTES, P. E. \emph{O novo tempo do mundo:} e
...
hegemônica -- realizar o trabalho sujo com zelo\footnote{Trabalho muito
  ...
  sindicato da então Siderúrgica Nacional, que era ligado à CUT,
  ...
  convergências pragmáticas entre o PT e o PSDB, o aparente paradoxo de
  que o governo de Lula realiza o programa de FHC, radicalizando-o: não
  ...
  banqueiros, núcleo duro do PSDB, e operários transformados em
  operadores de fundos de previdência, núcleo duro do PT. A identidade
  dos dois casos reside no controle do acesso aos fundos públicos, no
  conhecimento do `mapa da mina'.'' (Cf. OLIVEIRA, F. \emph{Crítica à
...
experiência concreta na formação do \emph{eu} com o mundo\footnote{FREUD.
  S. \emph{Psicologia das massas e análise do eu}. Porto Alegre: LPM,
...
sociais.\footnote{Essa noção me foi passada pelo grandioso artigo de
  ...
  gozo escópico no Facebook\emph{.}}
...
colaboracionistas\footnote{Há diferenças entre os colaboracionistas e os
  ...
  Arendt (Cf. ARENDT, H. \emph{Eichmann em Jerusalém.} Um relato sobre a
...
soberano sobre a decisão de morte\footnote{MBEMBE, A\emph{.
  Necropolítica}. São Paulo: edições N -- 1, 2017.}. Uma sacada
...
duas patas''\footnote{VOLTAIRE. \emph{Tratado de metafísica}. São Paulo;
...
como meta a abertura para um mundo verdadeiramente comum''\footnote{MBEMBE,
...
A engrenagem trepida... A bruma
neva... pouco importa que os corpos reduzidos à diferença racial
...
ficam''\footnote{Machado de Assis.}, o adjetivo \emph{negro} dado aos
...
rapidamente foi substantivado e
...
maneira da sombra e da luz''\footnote{SARTRE, J. P. \emph{O ser e o
  nada}: ensaio de ontologia fenomenológica. Petrópolis, RJ: Vozes,
...
face dos senhores do mundo.''\footnote{ADORNO e HORKHEIMER.
...
O negro, o emblema do Caos.\footnote{Manual de Montabert, redigido para
  artistas.}
\end{quote}
...
do próprio pensamento como natureza não reconciliada''\footnote{ADORNO e
  HORKHEIMER. \emph{Dialética do esclarecimento:} fragmentos
...
penetrar todos os momentos da existência'',\footnote{MBEMBE, A.
...
exploração''\footnote{MBEMBE, ibidem, p. 33.}.
...
poligenistas\footnote{Segundo Gislene Aparecida dos Santos: ``{[}...{]}
  ...
  os poligenistas, remetendo-se às origens separadas''. SANTOS, G. A.
  \emph{A invenção do ser negro:} um percurso das ideias que
  naturalizaram a inferioridade dos negros. Rio de Janeiro: Pallas,
  2006, p. 47.} que ainda têm no séc. XVIII um horizonte de busca da
...
ontológica\footnote{Ainda como diz Mbembe (op. cit., p. 39): ``O negro
...
humanos.''\footnote{} Sendo o branco europeu mais próximo da
...
humana os fará mais ricos''\footnote{SOUZA, O. T. \emph{O pensamento
...
servos.''\footnote{Mbembe, op. cit., p. 111.}
...
O que o presente significa para Fanon?\footnote{Utilizamos aqui a mesma
  ...
  para Hegel. ADORNO, T. W. \emph{Três estudos sobre Hegel}. São Paulo:
...
\emph{petit-nègre}\footnote{\emph{Petit-nègre} é um modo supostamente
  ...
  tornada senso comum durante boa parte do século XX: ``por ser ??um
...
socialmente.\footnote{Fazendo grosso modo uma arqueologia dessa noção de
  ...
  o qual houve um momento do século XX em que a identidade pôde repousar
...
dessa maneira, \emph{o nada}.\footnote{Como disse Mbembe: ``ao reduzir o
  ...
  ``raça'' possibilitou inúmeras catástrofes durante a modernidade (Cf.
  MBEMBE, A\emph{. Crítica à razão negra}. Lisboa: Antígona, 2014 p. 11)}
...
ao mundo e ao Outro.\footnote{Para concluir com Stuart Hall: ``A
  ...
  fantasia'' (Cf. HALL, S. \emph{A identidade cultural na
  pós-modernidade}. Rio de Janeiro: DP\&A, 2011, p.13.)}

Nascidas como ficção, dizia Bauman\footnote{BAUMAN, Z.
...
colapso.\footnote{HARVEY, D. \emph{The condition of post-modernity}.
...
As lições que se tiram disso são: a) no mundo dominado pela
sociabilidade capitalista busca-se reduzir o Eu a um produtor/consumidor
de mercadorias; b) a crise da modernidade não podendo mais concluir o
circuito de constante reposição da falta -- quer dizer, o consumo
...
identidade; e c) embora haja a tentativa de redução do Eu a um agente do
...
coordenadas sociais comprimidas pelo capital. Em suma, não existe
possibilidade de pertencimento no capitalismo.
...
\emph{branco}\footnote{FANON, F. \emph{Pele negra, máscaras brancas}.
  Tradução de Renato da Silveira. Salvador: EDUFBA, 2008.}, feita por
...
\emph{a}) aquela de superidentificação com os mecanismos colonialistas,
que adota e privilegia os aspectos dominantes da colônia, a branquitude,
a europeização, etc.; e \emph{b}) aquela que, \emph{negando}, busca um
retorno a si e se redobra em defender suas origens. Ambas são patologias
mistificadoras.
...
colonial\footnote{Aliás, como já salientava Bauman (op. cit., p. 35):
...
acidentalmente negro, se comporta\footnote{FANON. Idem, p. 81.}''. A
...
definidos pela própria linguagem. Por isso "Compreende-se {[}...{]} que
a primeira reação do negro seja a de dizer \emph{não} àqueles que tentam
defini-lo.''\footnote{FANON, Idem, p. 48, grifo meu.} É dessa limitação
...
sei de uma coisa"! diz o crítico citando o literato: "{[}...{]} que o
...
do mais complexo dos europeus''.\footnote{FANON. Idem, p.71.}
...
estrutura racista {[}...{]}.\footnote{Fanon, idem, p. 86.}
\end{quote}
...
o inferiorizado}.''\footnote{FANON, Id., p. 90.} Noutros termos, é o
...
desestruturação.''\footnote{FANON, Id., p. 93.}
...
estruturas sociais''\footnote{FANON, Idem, p. 96.}. Com isso, Fanon
...
inexoravelmente um retorno às raízes pré-coloniais...
...
ontológica.''\footnote{FANON, idem, p.103.}, é se essa proibição não
...
um homem como nós, nenhuma solução será viável'.''\footnote{FANON, idem,
...
NEGRO NEGRO NEGRO\footnote{De hoje em diante não quero\\
  ...
  In: Me gritaron negra, Victoria Santa Cruz (tradução minha).}
  \end{verse}
...
\emph{a}) a busca do conhecimento como forma política -- como sugere
...
equidade no infortúnio entre o negro e o judeu\footnote{O judeu e eu:
  ...
  seguramente um negrófobo. (in: FANON, Idem, p. 112, \emph{grifo meu}).}.
...
\emph{b}) Fracassado em sua busca da razão como forma de emancipação,
...
cosmos.''\footnote{FANON, idem, p. 115.} Imersa na poesia de um retorno
...
trabalhava o ouro e a prata.\footnote{FANON, idem, p. 118-9.}
\end{quote}
...
ponto de chegada, meio e não fim último\footnote{FANON, 2008, p. 121.
  Apud Jean-Paul Sartre. Orphée noir, prefácio à \emph{Anthologie de la
  poésie nègre et malgache}, p. XL et seq.??}.
\end{quote}
...
passada. E é por isso que Fanon continua: ``{[}...{]}
...
que abalará os assentamentos do mundo\footnote{FANON, 2008, p. 121. Apud
  Sartre. idem, p. XLIV.}.
\end{quote}
...
mim, este sentido (segundo Sartre) já estava lá {[}...{]}
esperando-me.'' e mais abaixo retruca: ``contra o devir histórico,
deveríamos opor a imprevisibilidade.''\footnote{FANON, 2008, p. 121}
...
doloroso...''\footnote{Ibidem.}, é para demonstrar como as ilusões
...
como a falta de algo. Ela é. Ela é aderente a si própria.\footnote{FANON,
  Idem, p. 122.}
\end{quote}
...
determinações\footnote{FICHTE, J. \emph{A doutrina da ciência de 1794}.
  Tradução de Rubens Rodrigues Torres Filho. p. 35-176. In:
  \_\_\_\_\_\_. \emph{Os pensadores}. São Paulo: Abril Cultural, 1984.??}
...
ironicamente Sartre: ``a existência precede a essência''.\footnote{Nesse
  ...
  aos outros.'' (SARTE, J-P. \emph{O existencialismo é um humanismo}.
  Tradução de Vergílio Ferreira, p. 21. In: \_\_\_\_\_\_. \emph{Os
...
estamos às voltas com velhos problemas: neorracismo\footnote{Aqui
  ...
  alteridade (apelido, cor da pele, práticas religiosas).??'' BALIBAR \&
  WALLERSTEIN. \emph{Race nation classe:} les identités ambigües??.
...
sustentação.\footnote{Retirei essa ideia do importante livro de Grespan
  GRESPAN, J. \emph{O negativo do capital:} o conceito de crise na
...
guerra''\footnote{ARANTES, op. cit., p. 63.}, de repente, ouvem-se
...
e de mulheres estruturalmente endividados {[}...{]} Mais característica
...
genes de origem africana durante o primeiro capitalismo {[}...{]} A este
...
\emph{devir-negro do mundo}\footnote{MBEMBE, op. cit., p.18.}.
\end{quote}
...
sugeriu numa entrevista\footnote{Naturalmente trata-se de uma ironia com
  ...
  agora é ter vantagem... (Concurso da prefeitura de SP verifica cor da
...
justiça. Por que Fanon? Por que agora? \footnote{Estou me referindo à
  brilhante tese de FAUSTINO, D. M. \emph{Por que Fanon, por que
  agora?}: ??Frantz Fanon e os fanonismos no Brasil. 2015. Tese
  (Doutorado). Programa de Pós-Graduação em Sociologia, Universidade
  Federal de São Carlos, São Carlos, SP, 2015.} São questões que ressoam
...
movimento negro a loucura patológica de reivindicar as origens... ou
...
raça cabe um lugar no mundo''\footnote{SANTOS,
...
teve a ousadia de ler Engels''\footnote{Fanon, Ibidem.}; e Fanon
...
ser escolhidas\footnote{A esse respeito ver RANCIÈRE, J. \emph{O odio à
...
Black}\footnote{Seriado famoso que teve a lucidez de demonstrar em toda
  ...
  que fugiria de nosso tema.}\emph{,} cujos gestores fossem nossos
...
capitalista, colonialista, apenas acidentalmente branca.''\footnote{FANON,
  op.cit., p.170.}
...
burocrática do Estado, sob a égide do PT, houve juntamente o aumento
exponencial do número de assassinatos de jovens no Brasil.\footnote{Cf.
...
\begin{quote}
{[}...{]} os novos processos de racialização visam marcar esses grupos
...
consciência\footnote{Temos uma interpretação desse duelo entre
  ...
  de que seu agir e existência dependem uma da outra.'' (Cf. COSSETIN,
...
muito tem a nos ensinar\footnote{Não se pode esquecer, contudo, de
  ...
  (ALTHUSSER, L. \emph{Ideologia e aparelhos ideológicos de Estado??},
  p.105-142. In: ZIZEK, S. (Org.) \emph{Um mapa da ideologia}. Rio de
...
subordinação do escravo quanto a dominação do senhor.''\footnote{BUTLER,
  op. cit., p. 43.}
...
trabalho\footnote{Trabalho=tripalium: Três paus, a que eram amarrados os
...
negro é visto como um vagabundo até que prove o contrário\footnote{A
  ...
  (CANDIDO, A. Dialética da Malandragem (caracterização das Memórias de
...
não-trabalho''\footnote{Uma das críticas mais contundentes à teologia do
  trabalho aparece na obra de Jappe. (in. JAPPE, A. \emph{As aventuras
...
\emph{a}) por meio da análise das ``instituições'' nativas; \emph{b})
...
etnográfica contribuiria para uma noção de \emph{raça}\footnote{Ao
  ...
  codificada (MBEMBE, op. cit., p. 11).} que seria coroada como uma
...
emancipatório.\footnote{E aqui falo, sobretudo, de Achille Mbembe.}
...
superação efetiva do quadro proposto pelo colonialismo.\footnote{A
  ...
  LACERDA, João Batista. \emph{Sobre os mestiços no Brasil}. Primeiro
...
autoformação do ser, enquanto ser social, não reside apenas na adaptação
...
limites impostos por ela; 2) a própria noção de raça incide na cor por
...
e racista que se mantém no poder até hoje.\footnote{A esse respeito o
  clássico ensaio de Schwarz ensina muito (Schwarz, R. \emph{Um mestre
...
identitário de sua particularidade.\footnote{O hipotético-leitor atento
  já percebeu que esta é a bula papal do integralismo...} Não é a
...
racista.\footnote{MBEMBE, A. \emph{Necropolítica: biopoder, soberania,
  estado de exceção, política da morte}. São Paulo; N-1 Edições, 2017.}
...
branca''\footnote{NASCIMENTO, A\emph{. Quilombismo}. São Paulo: Editora
...
africano, o líder do MNU apenas dirá que elas estão fundamentadas na
...
de Marx, ele era na verdade antimarxista\footnote{Isso pode iluminar, a
  ...
  Abdias do Nascimento preferiu o PDT ao PT -- por este na época ser
...
europeus contra todo continente e sua raça negra''\footnote{Ibidem.}
...
revolta na/pela ordem.\footnote{Cf. BERNARDO, J. \emph{Labirintos do
...
processo de habituação à morte do outro''\footnote{MBEMBE, op. cit. p.
...
presente''\footnote{ARANTES, op. cit. p. 91.}, ou ele se torna
...
na expulsão de famílias dos EUA pela etnologização da política. A
...
\chapter{Contra o retorno às raízes: identidade e identitarismo no centro
do debate}
...
deve tender ao universalismo inerente à condição humana''\footnote{FANON,
  F. \emph{Pele negra, máscaras brancas}. Salvador: EDUFBA, 2008, p. 32},
...
emotiva\footnote{Cf. ZIZEK, S. \emph{O
...
verdade\footnote{Disponível em:
  \textless{}http://www.esquerdadiario.com.br/Em-ato-contra-a-escravidao-na-Libia-grupo-pan-africanista-proibe-bandeiras-e-pessoas-brancas\textgreater{}.}.
...
é ser negro. Quando Fanon diz que o negro não é um homem (ibidem), já
...
párias -- e aqui cabem as mulheres, LGBTs, negros, indígenas, etc.
...
capitalismo''\footnote{FERNANDES, F. \emph{A integração do negro na
  sociedade de classes}. São Paulo: Globo, 2008 p.72} {[}\ldots{}{]}.~
...
\emph{a)} \emph{a chamada crise
do valor}, pois, \emph{(i)} o processo produtivo altera pouco a
...
em que se joga dinheiro para obter mais-dinheiro (D-D'); \emph{(ii)}
...
\emph{(iii) instala-se} um estado de crise permanente como forma de
governo; \emph{b)} \emph{o modo como esse processo estrangula o próprio
...
através de uma particularidade humana, tender ao universal.\footnote{FANON,
  Ibidem, p.166}
\end{quote}
