...
Diderot, Buffon e \index{Voltaire}Voltaire buscaram afastar"-se da metafísica apenas
...
socialmente.\footnote{Fazendo grosso modo uma arqueologia dessa noção de
  ...
  \emph{cogito} cartesiano, e seu desdobramento passa por Kant, \index{Fichte, Johann Gottlieb}Fichte e
...
especulativo do qual \index{Fanon, Frantz}Fanon era legitimo conhecedor. A palavra de ordem é
