...
Tornar"-se \emph{colaborador}\footnote{Colaborador como colaboracionista
  ...
  aqui exposto, Cf. \versal{ARANTES}, P. E. \emph{O novo tempo do mundo:} e
...
hegemônica -- realizar o trabalho sujo com zelo\footnote{Trabalho muito
  ...
  conhecimento do `mapa da mina'.'' (Cf. \versal{OLIVEIRA}, F. \emph{Crítica à
...
colaboracionistas\footnote{Há diferenças entre os colaboracionistas e os
  ...
  Arendt (Cf. \versal{ARENDT}, H. \emph{Eichmann em Jerusalém.} Um relato sobre a
...
soberano sobre a decisão de morte\footnote{\versal{MBEMBE}, A\emph{.
  Necropolítica}. São Paulo: edições \versal{N} -- 1, 2017.}. Uma sacada
...
exploração''\footnote{\versal{MBEMBE}, ibidem, p. 33.}.
...
ao mundo e ao Outro.\footnote{Para concluir com Stuart Hall: ``A
  ...
  fantasia'' (Cf. \versal{HALL}, S. \emph{A identidade cultural na
...
acidentalmente negro, se comporta\footnote{\versal{FANON}. Idem, p. 81.}''. A
...
defini"-lo.''\footnote{\versal{FANON}, Idem, p. 48, grifo meu.} É dessa limitação
...
do mais complexo dos europeus''.\footnote{\versal{FANON}. Idem, p.71.}
...
estrutura racista {[}\ldots{}{]}.\footnote{Fanon, idem, p. 86.}
\end{quote}
...
o inferiorizado}.''\footnote{\versal{FANON}, Id., p. 90.} Noutros termos, é o
...
desestruturação.''\footnote{\versal{FANON}, Id., p. 93.}
...
estruturas sociais''\footnote{\versal{FANON}, Idem, p. 96.}. Com isso, Fanon
...
ontológica.''\footnote{\versal{FANON}, idem, p.103.}, é se essa proibição não
...
um homem como nós, nenhuma solução será viável'.''\footnote{\versal{FANON}, idem,
...
equidade no infortúnio entre o negro e o judeu\footnote{O judeu e eu:
  ...
  seguramente um negrófobo. (in: \versal{FANON}, Idem, p. 112, \emph{grifo meu}).}.
...
cosmos.''\footnote{\versal{FANON}, idem, p. 115.} Imersa na poesia de um retorno
...
trabalhava o ouro e a prata.\footnote{\versal{FANON}, idem, p. 118-9.}
\end{quote}
...
ponto de chegada, meio e não fim último\footnote{\versal{FANON}, 2008, p. 121.
  ...
  poésie nègre et malgache}, p. \versal{XL} et seq.??}.
\end{quote}
...
que abalará os assentamentos do mundo\footnote{\versal{FANON}, 2008, p. 121. Apud
  Sartre. idem, p. \versal{XLIV}.}.
\end{quote}
...
doloroso\ldots{}''\footnote{Ibidem.}, é para demonstrar como as ilusões
...
guerra''\footnote{\versal{ARANTES}, op. cit., p. 63.}, de repente, ouvem"-se
...
\emph{devir"-negro do mundo}\footnote{\versal{MBEMBE}, op. cit., p.18.}.
\end{quote}
...
consciência\footnote{Temos uma interpretação desse duelo entre
  ...
  de que seu agir e existência dependem uma da outra.'' (Cf. \versal{COSSETIN},
...
muito tem a nos ensinar\footnote{Não se pode esquecer, contudo, de
  ...
  (\versal{ALTHUSSER}, L. \emph{Ideologia e aparelhos ideológicos de Estado??},
  p.105-142. In: \versal{ZIZEK}, S. (Org.) \emph{Um mapa da ideologia}. Rio de
...
não"-trabalho''\footnote{Uma das críticas mais contundentes à teologia do
  trabalho aparece na obra de Jappe. (in. \versal{JAPPE}, A. \emph{As aventuras
...
etnográfica contribuiria para uma noção de \emph{raça}\footnote{Ao
  ...
  codificada (\versal{MBEMBE}, op. cit., p. 11).} que seria coroada como uma
...
bem explicitado por Fanon\footnote{\versal{FANON}, op. cit.}. Estratificação
...
"brancos"\footnote{\versal{NASCIMENTO}, op. cit., p. 55.}.
\end{quote}
...
deixar de ser registrados na polícia em 1976\footnote{\versal{NASCIMENTO}, op.
...
transações.\footnote{\versal{NASCIMENTO} op. cit., p. 119.}
\end{quote}
...
revolta na/pela ordem.\footnote{Cf. \versal{BERNARDO}, J. \emph{Labirintos do
...
processo de habituação à morte do outro''\footnote{\versal{MBEMBE}, op. cit. p.
...
expectativas}\footnote{\versal{ARANTES}, op. cit.}, quem morre ou quem vive se
...
progresso\footnote{\versal{MBEMBE}, op. cit.}.
...
presente''\footnote{\versal{ARANTES}, op. cit. p. 91.}, ou ele se torna
...
emotiva\footnote{Cf. \versal{ZIZEK}, S. \emph{O
...
em que se joga dinheiro para obter mais"-dinheiro (\versal{D"-D}'); \emph{(ii)}
